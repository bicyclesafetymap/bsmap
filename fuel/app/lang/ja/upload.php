...
return array(
    ...
    'error_'.\Upload::UPLOAD_ERR_INI_SIZE               => 'php.ini で設定されている最大サイズを越えています',
    'error_'.\Upload::UPLOAD_ERR_FORM_SIZE              => 'フォームの MAX_FILE_SIZE を越えています',
    'error_'.\Upload::UPLOAD_ERR_PARTIAL                => 'The uploaded file was only partially uploaded',
    'error_'.\Upload::UPLOAD_ERR_NO_FILE                => 'ファイルが選択されていません',
